...
export class ProjectsPage {
   ...
   initProjectsView = () => {
      ...
      let pinImage = new google.maps.MarkerImage("http://chart.apis.google.com/chart?chst=d_map_pin_letter&chld=%E2%80%A2|E31A52",
      ...
      for (let i = 0; i < this.data.length; i++) {
         ...
         marker.addListener('click', () => {
            ...
            $('#projects-modal').find('.modal-info').html(template);
         });
      }
