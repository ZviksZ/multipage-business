...
export class ProductsMainSlider {
   constructor() {
      this.$slider = $('#product-slider-main');

      if (this.$slider.length === 0) return false;

      this.$sliderControls = $('#product-slider-main_controls');
   ...
   initSlider = () => {
      this.$instance = new Swiper(this.$slider, {
         ...
         //spaceBetween: 32,
         navigation: {
            nextEl: '#product-slider-main_controls .swiper-button-next',
            prevEl: '#product-slider-main_controls .swiper-button-prev'
         },
         pagination: {
            el: '#product-slider-main_controls .swiper-progressbar',
            type: 'progressbar'
         },
         on: {
            slideChange: () => {
